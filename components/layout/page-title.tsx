...
export default function PageTitle({ title, backUrl, createLink }: Props) {
  return (
    <div className="flex justify-between border-b border-gray-200 dark:border-gray-800 pb-4 pl-4 pr-6 pt-4 sm:pl-6 lg:pl-8 xl:border-t-0 xl:pl-6 xl:pt-6 dark:bg-black dark:text-white">
