    ...
    <div className="dark:text-gray-100 h-full">
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="mx-auto max-w-7xl py-32">
          ...
          <div className="mb-8">
            <h2 className="text-xl font-bold mb-2 underline">4. Limitations</h2>
            <p className="mb-4">
          ...
          <div className="mb-8">
            ...
            <p className="mb-4">
              ...
              least eighteen (18) years old. By accessing or using ManagePrompt,
          ...
          <div className="mb-8">
            ...
            <p className="mb-4">
              ...
              by us, may harm or offend ManagePrompt or users of Service or
