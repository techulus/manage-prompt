      ...
      <form className="p-6" action={runWorkflow}>
        ...
        <Tabs defaultValue="compose">
          ...
          <TabsContent value="deploy">
            <iframe
              src={`https//api.apiembed.com/?source=${process.env.NEXT_PUBLIC_APP_BASE_URL}/api/har/${workflow.shortId}&targets=shell:curl,node:unirest,java:unirest,python:requests,php:curl,ruby:native,objc:nsurlsession,go:native`}
              width="100%"
              height="500px"
              seamless
            ></iframe>
