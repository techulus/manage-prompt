      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="mx-auto max-w-7xl py-32">
          ...
          <p className="mt-3">
            ...
            that they shared and/or collect in manageprompt.com. This policy is
          ...
          <h2 className="mt-4 text-2xl font-bold">Information we collect</h2>
          ...
          <h2 className="mt-4 text-2xl font-bold">Log Files</h2>

          <p className="mt-3">
            manageprompt.com follows a standard procedure of using log files.
          ...
          <h2 className="mt-4 text-2xl font-bold">Cookies and Web Beacons</h2>

          <p className="mt-3">
            Like any other website, manageprompt.com uses &apos;cookies&apos;.
          ...
          <p className="mt-3">
            ...
            advertising partners of manageprompt.com.
          </p>

          <p className="mt-3">
            Third-party ad servers or ad networks uses technologies like
            cookies, JavaScript, or Web Beacons that are used in their
            respective advertisements and links that appear on manageprompt.com,
          ...
          <p className="mt-3">
            Note that manageprompt.com has no access to or control over these
          ...
          <p className="mt-3">
            manageprompt.com&apos;s Privacy Policy does not apply to other
          ...
          <p className="mt-3">
            manageprompt.com does not knowingly collect any Personal
